...
const SingleSelect = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center jusfity-between bg-white py-2 px-4 block w-full rounded-xs-plus border-1 border-solid ${outlineStyle()} border-solid`}
      ...
      >
        <input
          ...
          className={`flex-1 font-poppins ${
            ...
            selected ? "text-sm text-black" : "text-sm text-black"
          }`}
      ...
      {open && (
        <>
          <div
            className={`absolute ${
              isReverse ? "bottom-full" : "top-full"
            } w-full z-10`}
          >
            ...
            <div
              ...
              className="shadow-drop-down bg-white w-full rounded-xs-plus max-h-60 overflow-y-scroll border-1 border-black border-solid"
            >
