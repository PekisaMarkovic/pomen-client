...
import { InputVaraint } from "@/components/core/inputs/InputText";
...
export const inputTextStyle = ({
  ...
  switch (variant) {
    case "simple":
      return `font-montserrat bg-white border-none ${
    ...
    default:
      return `font-montserrat bg-white border-1 ${
        error ? "border-red border-solid" : "border-black border-solid"
